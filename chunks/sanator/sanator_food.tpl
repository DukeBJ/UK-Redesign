    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-xs-12">
                <div class="heading">
                    <h2>{$_modx->resource.sanator_food_title}</h2>
                    <p>{$_modx->resource.sanator_food_description}</p>
