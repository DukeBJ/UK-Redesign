...
<div id="pop-question" class="modal pop-question">
    ...
    <div class="modal__content">
        <div class="pop-question__content">
            ...
            <form action="" class="form">
                <div class="form__block">
                    <div class="form__input"><input type="text" id="text-6"><label for="text-6">Как к Вам
                            обращаться?</label></div>
                    <div class="form__input"><input type="email" id="email-2"><label for="email-2">Адрес
                            e-mail</label></div>
                </div>
                <textarea placeholder="Ваш вопрос"></textarea><a href="#" data-pop="data-pop" class="btn btn-sandy">
                    <svg xmlns="http://www.w3.org/2000/svg" width="273" height="50" viewBox="0 0 273 50">
                        <defs>
                            <style>.cls-1 {
                                    fill: #f4e07a;
