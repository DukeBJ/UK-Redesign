...
<section class="room">
    <div class="container">
        <div class="row middle-xs center-xs">
            ...
            <div id="doubleroom" class="room__block" style="background:url({'template_url'|config}img/sanatorium-Lenin.png) no-repeat;background-size: cover;background-position: center center;">
                <div class="room__block__content">
                    <div class="heading heading-secondary">
            ...
            <div id="apartment" class="room__block" style="background:url({'template_url'|config}img/sanatorium-Lenin.png) no-repeat;background-size: cover;background-position: center center;">
                <div class="room__block__content">
                    <div class="heading heading-secondary">
                        <h2>Апартаменты</h2>
                        <p>Регулярно в наших санаториях и домах отдыха проходят интересные акции. Советуем Вам ознакомиться со списком, чтобы не пропустить скидки и бонусы!</p>
            ...
            <div id="lux" class="room__block" style="background:url({'template_url'|config}img/sanatorium-Lenin.png) no-repeat;background-size: cover;background-position: center center;">
                <div class="room__block__content">
                    <div class="heading heading-secondary">
                        <h2>Люкс</h2>
                        <p>Регулярно в наших санаториях и домах отдыха проходят интересные акции. Советуем Вам ознакомиться со списком, чтобы не пропустить скидки и бонусы!</p>
            ...
            <div id="doublelux" class="room__block" style="background:url({'template_url'|config}img/sanatorium-Lenin.png) no-repeat;background-size: cover;background-position: center center;">
                <div class="room__block__content">
                    <div class="heading heading-secondary">
