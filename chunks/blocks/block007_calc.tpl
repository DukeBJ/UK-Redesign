        ...
        <div class="row middle-xs center-xs">
            <div class="col-xs-12">
                <div class="heading">
                    ...
                    <p>Посчитайте примерную стоимость путёвки в санаторий на одного человека.</p>
                </div>
            </div>
            <div class="col-xs-12">
                <form class="form">
