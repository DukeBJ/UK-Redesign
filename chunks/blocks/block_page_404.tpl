...
<!-- END -->
<section class="search 404_page">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="heading">
                    <h2>Что ищем?</h2>
                    <p>Возможно мы сможем найти то, что вас интересует.</p>
                </div>
            </div>
            <div class="col-xs-12">
