    ...
    <div class="menu__content">
        <div class="menu__content__block">
            ...
            <div class="menu__block">
                ...
                <h4 class="menu__category-subheader"><a href="{'51'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'980'|url}">Номера</a></li>
                    <li><a href="{'1014'|url}">Лечение</a></li>
                    <li><a href="{'958'|url}">Цены</a></li>
                </ul>
                <h4 class="menu__category-subheader"><a href="{'84'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'1209'|url}">Номера</a></li>
                    <li><a href="{'1043'|url}">Лечение</a></li>
                    <li><a href="{'1153'|url}">Цены</a></li>
                </ul>
                <h4 class="menu__category-subheader"><a href="{'127'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'1218'|url}">Номера</a></li>
                    <li><a href="{'1075'|url}">Лечение</a></li>
                    <li><a href="{'1157'|url}">Цены</a></li>
                </ul>
                <h4 class="menu__category-subheader"><a href="{'142'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
            ...
            <div class="menu__block">
                ...
                <h4 class="menu__category-subheader"><a href="{'289'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'1225'|url}">Номера</a></li>
                    <li><a href="{'1161'|url}">Цены</a></li>
                </ul> 
                <h4 class="menu__category-subheader"><a href="{'296'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'1339'|url}">Номера</a></li>
                    <li><a href="{'1232'|url}">Цены</a></li>
                </ul> 
                <h4 class="menu__category-subheader"><a href="{'303'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'1346'|url}">Номера</a></li>
                    <li><a href="{'1283'|url}">Цены</a></li>
                </ul> 
                <h4 class="menu__category-subheader"><a href="{'310'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
                <ul>
                    <li><a href="{'1294'|url}">Номера</a></li>
                    <li><a href="{'1289'|url}">Цены</a></li>
                </ul> 
                <h4 class="menu__category-subheader"><a href="{'318'|url}">{*!!!добавить тайтл со страницы санатория!!!*}</a></h4>
            </div>
            <div class="menu__block">
