    ...
    <div class="menu__content">
        <div class="menu__content__block">
            ...
            <div class="menu__block">
                <h3><a href="{'912'|url}">О курорте</a><i class="icon icon-left-arrow"></i></h3>
                ...
                <h3><a href="{'161'|url}">Контакты</a></h3>
                <h3><a href="{'962'|url}">Цены</a></h3>
                <h3><a href="{'920'|url}">Блог</a><i class="icon icon-left-arrow"></i></h3>
                <ul>
            ...
            <div class="menu__block">
                <h3><a href="{'50'|url}">Санатории</a><i class="icon icon-left-arrow"></i></h3>
            ...
            <div class="menu__block">
                <h3><a href="{'992'|url}">Лечение</a><i class="icon icon-left-arrow"></i></h3>
                <ul>
                ...
                <h3><a href="{'915'|url}">Досуг</a><i class="icon icon-left-arrow"></i></h3>
