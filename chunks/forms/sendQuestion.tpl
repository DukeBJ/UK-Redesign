<form action="" class="form ajax_form">
    ...
    <input type="text" name="parent" value="{$_modx->resource.id}">
    ...
    <div class="form__block">
        ...
        <div class="form__input"><input type="email" name="email" value="[[!+fi.email]]" id="email-2"><label for="email-2">Адрес
                e-mail</label></div>
    </div>
