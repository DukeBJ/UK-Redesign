<section class="gallery gallery_about wave-dn-wt" style="background:url({$template}img/photogallery.jpg) no-repeat;background-size: cover;">
    <div class="healthy-children__content">
        <div class="container">
            <div class="raw">
                <div class="col-xs-12">
                    <h2>{$_modx->resource.gallery_title}</h2>
                    <p>{$_modx->resource.gallery_description}</p>
                    <a href="{$_modx->makeUrl(918)}" class="btn btn-white btn-center">{ignore}
