        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12">
                    ...
                    <form action="" class="form"><select><option value="1">За всё время</option><option value="2">2018</option><option value="3">2017</option><option value="4">2016</option></select></form>
                    <div class="tags">
                        <ul>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="shares__block"><img src="img/lenin.png" alt="">
                        <a class="img">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="shares__block"><img src="img/lenin.png" alt="">
                        <a class="img">
                            <h4>Снижение цен на всю осень!</h4><img src="img/separation-line.svg" alt="">
