            ...
            <div class="row">
                ...
                <div class="col-xs-12">
                    <div class="license__content">
                        <div class="license__block"><img src="{'template_url'|config}img/honors/honors-1.png" srcset="img/honors/honors-1@2x.png 2x, img/honors/honors-1@3x.png 3x"></div>
                        <div class="license__block"><img src="{'template_url'|config}img/honors/honors-2.png" srcset="img/honors/honors-2@2x.png 2x, img/honors/honors-2@3x.png 3x"></div>
                        <div class="license__block"><img src="{'template_url'|config}img/honors/honors-3.png" srcset="img/honors/honors-3@2x.png 2x, img/honors/honors-3@3x.png 3x"></div>
                        <div class="license__block"><img src="{'template_url'|config}img/honors/honors-4.png" srcset="img/honors/honors-4@2x.png 2x, img/honors/honors-4@3x.png 3x"></div>
                    </div>
                </div>
