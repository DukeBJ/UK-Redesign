            ...
            <div class="row">
                    ...
                    <div id="pdopage">
                        <div class="rows">
                            {'!pdoPage'|snippet:[
                                ...
                                'limit' => 1,
                                'ajaxMode' => 'button',
                                'ajaxTplMore' => '@INLINE <button class="btn btn-sandy btn-center btn-more">
                ...
                <div class="col-xs-12 center-xs">
                    <div class="button_margin">
                        ...
                        <button class="btn btn-sandy btn-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="273" height="50" viewBox="0 0 273 50"><defs>
                                    {ignore}
                                    <style>.cls-1{fill:#f4e07a;}.cls-1,.cls-2{fill-rule:evenodd;}.cls-2{fill:none;stroke:#fff;stroke-miterlimit:10;stroke-width:2px;}</style>
                                    {/ignore}
